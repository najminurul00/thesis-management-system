            ...
            case 'dosen_pembimbing':
                return [
                    ...baseItems,
                    {
                        ...
                        href: `/dashboard/dosen-pembimbing/students`
                    },
                    {
                        name: 'Input Nilai',
                        href: `/dashboard/dosen-pembimbing/scores`
                    }
                ];
            case 'dosen_penguji':
                return [
                    ...baseItems,
                    {
                        ...
                        href: `/dashboard/dosen-penguji/students`
                    },
                    {
                        name: 'Input Nilai',
                        href: `/dashboard/dosen-penguji/scores`
                    }
                ];
            case 'admin_prodi':
                return [
                    ...baseItems,
                    {
                        ...
                        href: `/dashboard/admin-prodi/add-student`
                    },
                    {
                        name: 'Upload Tesis',
                        href: `/dashboard/admin-prodi/upload-thesis`
                    },
                    {
                        name: 'Hasil Akhir',
                        href: `/dashboard/admin-prodi/results`
                    }
                ];
            default:
                return baseItems;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "lg:hidden bg-white shadow-sm border-b p-4",
...
__turbopack_context__.s({
    ...
    "getDraftByStudentId": (()=>getDraftByStudentId),
    "getScoreByStudentId": (()=>getScoreByStudentId),
    "getStudentById": (()=>getStudentById),
    "getStudentsByDosenPembimbing": (()=>getStudentsByDosenPembimbing),
    "getStudentsByDosenPenguji": (()=>getStudentsByDosenPenguji),
    "mockStudents": (()=>mockStudents),
    "mockThesisDrafts": (()=>mockThesisDrafts),
    "mockThesisScores": (()=>mockThesisScores),
    "mockUsers": (()=>mockUsers),
...
const mockStudents = [
    ...
    },
    {
        ...
        nim: '2021002',
        name: 'Sari Dewi',
        thesis_title: 'Sistem Informasi Manajemen Perpustakaan Berbasis Web',
        dosen_pembimbing_id: 2,
        dosen_penguji_id: 3,
    ...
    },
    {
        ...
        nim: '2021003',
        name: 'Ahmad Rahman',
        thesis_title: 'Analisis Keamanan Jaringan Menggunakan Deep Learning',
        dosen_pembimbing_id: 2,
        dosen_penguji_id: 3,
        created_at: '2024-01-17T10:00:00Z'
    }
];
const mockThesisDrafts = [
    {
        id: 1,
        student_id: 1,
        file_name: 'Draft_Tesis_Budi_Santoso.pdf',
        file_path: '/uploads/draft_tesis_budi_santoso.pdf',
        file_size: 2048000,
        uploaded_by: 4,
    ...
    },
    {
        id: 2,
        student_id: 2,
        file_name: 'Draft_Tesis_Sari_Dewi.pdf',
        file_path: '/uploads/draft_tesis_sari_dewi.pdf',
        file_size: 3072000,
        uploaded_by: 4,
...
const mockUsers = [
    ...
    },
    {
        id: 2,
        username: 'dospem1',
        email: 'dospem1@university.edu',
        role: 'dosen_pembimbing',
        full_name: 'Dr. Ahmad Pembimbing'
    },
    {
        id: 3,
        username: 'dospenguji1',
        email: 'dospenguji1@university.edu',
        role: 'dosen_penguji',
        full_name: 'Dr. Siti Penguji'
    },
    {
        id: 4,
        username: 'adminprodi1',
        email: 'adminprodi1@university.edu',
        role: 'admin_prodi',
        full_name: 'Admin Prodi Informatika'
    }
];
const mockThesisScores = [
    {
        id: 1,
        student_id: 1,
        dosbim_score: 85,
        dospenguji_score: 88,
        final_score: 86.5,
        dosbim_updated_at: '2024-01-25T10:00:00Z',
        dospenguji_updated_at: '2024-01-26T11:00:00Z',
    ...
    },
    {
        ...
        student_id: 2,
        dosbim_score: 90,
        dospenguji_score: undefined,
        final_score: undefined,
        dosbim_updated_at: '2024-01-25T14:00:00Z',
        dospenguji_updated_at: undefined,
        updated_at: '2024-01-25T14:00:00Z'
    },
    {
        id: 3,
        student_id: 3,
        dosbim_score: undefined,
        dospenguji_score: undefined,
        final_score: undefined,
        dosbim_updated_at: undefined,
        dospenguji_updated_at: undefined,
        updated_at: '2024-01-17T10:00:00Z'
    }
];
function getStudentsByDosenPembimbing(dosenId) {
    return mockStudents.filter((student)=>student.dosen_pembimbing_id === dosenId);
}
function getStudentsByDosenPenguji(dosenId) {
    return mockStudents.filter((student)=>student.dosen_penguji_id === dosenId);
}
function getStudentById(id) {
    return mockStudents.find((student)=>student.id === id);
}
function getScoreByStudentId(studentId) {
    return mockThesisScores.find((score)=>score.student_id === studentId);
}
function getDraftByStudentId(studentId) {
    return mockThesisDrafts.find((draft)=>draft.student_id === studentId);
}
function calculateFinalScore(dosbimScore, dospengujiScore) {
    if (dosbimScore !== undefined && dospengujiScore !== undefined) {
        return (dosbimScore + dospengujiScore) / 2;
    }
    return undefined;
}
function updateScore(studentId, scoreType, score) {
    const scoreIndex = mockThesisScores.findIndex((s)=>s.student_id === studentId);
    if (scoreIndex === -1) {
        // Create new score record
        const newScore = {
            id: mockThesisScores.length + 1,
            student_id: studentId,
            updated_at: new Date().toISOString()
        };
        if (scoreType === 'dosbim') {
            newScore.dosbim_score = score;
            newScore.dosbim_updated_at = new Date().toISOString();
        } else {
            newScore.dospenguji_score = score;
            newScore.dospenguji_updated_at = new Date().toISOString();
        }
        mockThesisScores.push(newScore);
    } else {
        // Update existing score
        const existingScore = mockThesisScores[scoreIndex];
        if (scoreType === 'dosbim') {
            existingScore.dosbim_score = score;
            existingScore.dosbim_updated_at = new Date().toISOString();
        } else {
            existingScore.dospenguji_score = score;
            existingScore.dospenguji_updated_at = new Date().toISOString();
        }
        existingScore.updated_at = new Date().toISOString();
        // Recalculate final score if both scores are available
        existingScore.final_score = calculateFinalScore(existingScore.dosbim_score, existingScore.dospenguji_score);
    }
    return true;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/src/app/dashboard/dosen-penguji/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>DosenPengujiDashboard)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
;
;
function DosenPengujiDashboard() {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DosenPengujiDashboard.useEffect": ()=>{
            // Get user from session - in production, verify with API
            const mockUser = {
                id: 3,
                username: 'dospenguji1',
                email: 'dospenguji1@university.edu',
            ...
            setUser(mockUser);
            // Get students assigned to this dosen penguji
            const assignedStudents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStudentsByDosenPenguji"])(mockUser.id);
    ...
    const handleScoreSubmit = async (e)=>{
        ...
        try {
            ...
            if (isNaN(scoreValue) || scoreValue < 0 || scoreValue > 100) {
                setMessage('Nilai harus berupa angka antara 0-100');
                return;
            }
            // Update score in mock data
            const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateScore"])(selectedStudent.id, 'dospenguji', scoreValue);
            if (success) {
    ...
    const openScoreDialog = (student)=>{
        ...
        const existingScore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getScoreByStudentId"])(student.id);
        setScore(existingScore?.dospenguji_score?.toString() || '');
        setMessage('');
        setDialogOpen(true);
    };
    const handleDownloadPDF = async (studentId)=>{
        try {
            const response = await fetch(`/api/report/pdf?studentId=${studentId}`);
            if (response.ok) {
                const blob = await response.blob();
                const url = window.URL.createObjectURL(blob);
                const a = document.createElement('a');
                a.href = url;
                a.download = `nilai-akhir-${studentId}.pdf`;
    ...
    if (loading || !user) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
            lineNumber: 106,
            columnNumber: 12
        }, this);
    }
    const studentsWithScores = students.map((student)=>{
        const scoreData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getScoreByStudentId"])(student.id);
        return {
            ...student,
            scoreData
        };
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            ...
                            children: "Dashboard Dosen Penguji"
                        }, void 0, false, {
                            fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                            lineNumber: 118,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Kelola mahasiswa ujian dan input nilai"
                        }, void 0, false, {
                            fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                            lineNumber: 119,
                            columnNumber: 11
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                        ...
                                        children: "Total Mahasiswa Ujian"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                        lineNumber: 126,
                                        columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "text-2xl font-bold",
                                        children: studentsWithScores.filter((s)=>s.scoreData?.dospenguji_score).length
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                        lineNumber: 138,
                                        columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                    children: "Daftar mahasiswa yang akan Anda uji"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                    lineNumber: 160,
                                    columnNumber: 13
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Table"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                        children: studentsWithScores.map((student)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        children: student.scoreData?.dosbim_score ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "font-medium",
                                                            children: student.scoreData.dosbim_score
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                                            lineNumber: 185,
                                                            columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        children: student.scoreData?.dospenguji_score ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                            className: "bg-green-100 text-green-800",
                                                            children: student.scoreData.dospenguji_score
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                                            lineNumber: 192,
                                                            columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        children: student.scoreData?.final_score ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "font-bold text-green-600",
                                                            children: student.scoreData.final_score
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                                            lineNumber: 201,
                                                            columnNumber: 25
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                    variant: "outline",
                                                                    size: "sm",
                                                                    onClick: ()=>openScoreDialog(student),
                                                                    children: student.scoreData?.dospenguji_score ? 'Edit Nilai' : 'Input Nilai'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                                                    lineNumber: 208,
                                                                    columnNumber: 25
                                                                }, this),
                                                                student.scoreData?.final_score && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                    variant: "secondary",
                                                                    size: "sm",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                        children: selectedStudent && `Mahasiswa: ${selectedStudent.name} (${selectedStudent.nim})`
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                        lineNumber: 238,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                ...
                                children: [
                                    message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                                        variant: message.includes('berhasil') ? 'default' : 'destructive',
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                type: "submit",
                                                disabled: submitting,
                                                children: submitting ? 'Menyimpan...' : 'Simpan Nilai'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/dosen-penguji/page.tsx",
                                                lineNumber: 273,
                                                columnNumber: 17
...
_s(DosenPengujiDashboard, "BGZKvzqRqt4uo50c3QfeN9qEiqU=");
_c = DosenPengujiDashboard;
var _c;
__turbopack_context__.k.register(_c, "DosenPengujiDashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_736110ae._.js.map